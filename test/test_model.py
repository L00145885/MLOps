...
def test_data_loading(sample_data: pd.DataFrame, tmp_path: pytest.TempPathFactory) -> None:
...
def test_model_saving(sample_data: pd.DataFrame, tmp_path: pytest.TempPathFactory) -> None:
